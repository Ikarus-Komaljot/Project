...
export default function Footer() {
  return (
    <div class="flex items-end w-full min-h-11 bg-white" id="contact">
      <footer class="w-full text-white body-font bg-black">
        <div class="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap bg-black">
          <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
            ...
            <p class="mt-2 text-sm text-gray-300">Explore & Learn with us!</p>
        ...
        <div class="bg-[#1ba8b3c5]">
          <div class="container px-5 py-4 ">
            <p class="text-sm text-gray-900 capitalize xl:text-center font-medium">
